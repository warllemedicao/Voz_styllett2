...
8. **Sincronização:** Envia checkpoints e resultados de volta para o bucket R2 no prefixo `super_Voz_outputs/`.

## Configuração do Bucket (Cloudflare R2)

Para usar este projeto, você deve criar um bucket no Cloudflare R2 e preencher as credenciais nos arquivos de configuração YAML:
...
- `super_Voz_outputs/`: Onde os resultados e checkpoints serão salvos.
